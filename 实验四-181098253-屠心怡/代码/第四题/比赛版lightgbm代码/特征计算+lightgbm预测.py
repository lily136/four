...
# In[ ]:
user_log = pd.read_csv('C:/Users/tuxin/Desktop/data_format1 (1)/data_format1/user_log_format1.csv', dtype={'time_stamp':'str'})
user_info = pd.read_csv('C:/Users/tuxin/Desktop/data_format1 (1)/data_format1/user_info_format1.csv')
train_data1 = pd.read_csv('C:/Users/tuxin/Desktop/data_format1 (1)/data_format1/train_format1.csv')
sub_data = pd.read_csv('C:/Users/tuxin/Desktop/data_format1 (1)/data_format1/test_format1.csv')
data_train = pd.read_csv('C:/Users/tuxin/Desktop/data_format1 (1)/data_format1/train_format2.csv')
...
def get_train_testDF(train_df,label_df):
    ...
    for train_index, test_index in skv.split(X=train_df, y=label_df):
        train_x, train_y, test_x, test_y = train_df.iloc[train_index, :], label_df.iloc[train_index],                                             train_df.iloc[test_index, :], label_df.iloc[test_index]
...
pred_lgbms = []
for i in range(5):
    print('============================LGB training use Data {}/5============================'.format(i+1))
    model_lgb = lgb.LGBMClassifier(
        max_depth=10, # 8
        n_estimators=1000,
        min_child_weight=200, 
...
# submission.drop(['origin'], axis=1, inplace=True)
submission.to_csv('submission_KFold_lgb4.csv', index=False)
...
pred_cats = []
for i in range(5):
    print('============================CAT training use Data {}/5============================'.format(i+1))
    model_cat = cat.CatBoostClassifier(learning_rate=0.02, iterations=5000, eval_metric='AUC', od_wait=50,
...
pred_xgbs = []
for i in range(5):
    print('============================XGB training use Data {}/5============================'.format(i+1))
    model_xgb = xgb.XGBClassifier(
        max_depth=10, # raw8
        n_estimators=1000,
        min_child_weight=300, 
