...
if __name__ == "__main__":
    ...
    df_train = spark.read.option("header", True).csv("C:/Users/tuxin/Desktop/data_format1 (1)/data_format1/test_format1.csv")
    ...
    df_train.show(10)
    df_train = df_train.withColumnRenamed("prob", "label")
    ...
    df_train.show(10)
    #df_train.repartition(1).write.csv("test_add_action_type", encoding="utf-8", header=True)
